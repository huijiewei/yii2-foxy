...
class FoxyPlugin implements PluginInterface, EventSubscriberInterface
{
    protected $composer;
    protected $io;
    ...
    protected function getPackageConfig()
    {
        ...
        $packageConfig = isset($packageConfig['yii2-foxy']) && \is_array($packageConfig['yii2-foxy'])
            ? $packageConfig['yii2-foxy']
            : array();

        $this->packageConfig = array_merge($this->defaultConfig, $packageConfig);
